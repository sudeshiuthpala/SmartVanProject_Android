...
public class SalaryPaymentBackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    SalaryPaymentBackend(Context ctx){
        context= ctx;
    }
    @Override
    protected String doInBackground(String... params) {
        String reg_url="http://192.168.1.102/smartvan/paySalary.php";
        try {
    ...
    protected void onPostExecute(String s) {
        Toast.makeText(context,"Send Rquest to driver!",Toast.LENGTH_LONG).show();
