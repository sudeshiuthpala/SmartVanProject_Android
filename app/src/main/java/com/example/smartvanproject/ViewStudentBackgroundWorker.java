...
public class ViewStudentBackgroundWorker extends AsyncTask<String,Child,Void> {
        String json_string="http://192.168.1.102/smartvan/viewStudent.php";
        Context context;
        Activity activity;
        ...
        ViewStudentBackgroundWorker(Context ctx){
        context=ctx;
...
protected void onPreExecute() {
        ...
        adapter=new RecyclerAdapterChild(arrayList,context);
