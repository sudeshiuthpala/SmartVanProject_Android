...
public class NonPaidSalaryBackgroundWorker extends AsyncTask<String,NonSalaryPayment,Void> {
    String json_string="http://192.168.1.102/smartvan/salaryNonPaidList.php";
    Context context;
    Activity activity;
    ...
    ArrayList<NonSalaryPayment> arrayList=new ArrayList<>();
    ProgressDialog progressDialog;
    NonPaidSalaryBackgroundWorker(Context ctx){
        context=ctx;
    ...
    protected Void doInBackground(String... params) {
        try {
            ...
            while (count<jsonArray.length()){
                ...
                count++;
                NonSalaryPayment fee=new NonSalaryPayment(jo.getString("driverid"),jo.getString("fname"),jo.getString("lname"));
                publishProgress(fee);
                Thread.sleep(1000);
    ...
    protected void onPreExecute() {
        recyclerView=(RecyclerView)activity.findViewById(R.id.nonPaidSalaryRecyclerView);
        layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        adapter=new RecyclerAdapterNonSalary(arrayList,context);
...
//    }
    ...
    @Override
    protected void onProgressUpdate(NonSalaryPayment... values) {
