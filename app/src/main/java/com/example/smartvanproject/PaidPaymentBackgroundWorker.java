...
public class PaidPaymentBackgroundWorker extends AsyncTask<String,FeePayment,Void> {
    ...
    PaidPaymentBackgroundWorker(Context ctx){
        context=ctx;
    ...
    protected void onPreExecute() {
        recyclerView=(RecyclerView)activity.findViewById(R.id.paidRecyclerView);
        layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        adapter=new RecyclerAdapterFees(arrayList,context);
