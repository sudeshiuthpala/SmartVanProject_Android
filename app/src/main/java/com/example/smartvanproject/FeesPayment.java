...
public class FeesPayment extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    TabLayout tabLayout;
...
//
        ...
        year.setAdapter(new ArrayAdapter<>(FeesPayment.this,android.R.layout.simple_spinner_dropdown_item,yearList));
        ...
        month = findViewById(R.id.monthlist);
        ...
        month.setAdapter(new ArrayAdapter<>(FeesPayment.this,android.R.layout.simple_spinner_dropdown_item,monthList));
        ...
        nonpaid=findViewById(R.id.nonpaid);
        paid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(FeesPayment.this,PaidPayment.class);
                i.putExtra("vanId",selected);
        ...
        nonpaid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(FeesPayment.this,NonPaidPayment.class);
                i.putExtra("vanId",selected);
                i.putExtra("year",yearl);
                i.putExtra("month",monthselect);
                i.putExtra("name",r);
    ...
    protected void onStart() {
        super.onStart();
        FeesPayment.BackTask bt=new FeesPayment.BackTask();
        bt.execute(r);
    }
    @Override
