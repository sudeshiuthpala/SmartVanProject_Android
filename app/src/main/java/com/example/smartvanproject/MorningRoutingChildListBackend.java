...
public class MorningRoutingChildListBackend extends AsyncTask<String,TripChild,Void> {
    String json_string="http://192.168.1.102/smartvan/viewMorningTripChild.php";
    Context context;
    Activity activity;
    ...
    ArrayList<TripChild> arrayList=new ArrayList<>();
    ProgressDialog progressDialog;
    MorningRoutingChildListBackend(Context ctx){
        context=ctx;
    ...
    protected Void doInBackground(String... params) {
        try {
            ...
            while (count<jsonArray.length()){
                ...
                count++;
                TripChild child=new TripChild(jo.getString("fname"),jo.getString("lname"),jo.getString("school"),jo.getString("location"));
    ...
    protected void onPreExecute() {
        recyclerView=(RecyclerView)activity.findViewById(R.id.recyclerviewmorningchildlist);
        layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        adapter=new RecyclerAdapterTripChild(arrayList,context);
...
//    }
    ...
    @Override
    protected void onProgressUpdate(TripChild... values) {
