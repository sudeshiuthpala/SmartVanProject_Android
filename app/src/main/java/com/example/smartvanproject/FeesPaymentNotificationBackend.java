...
public class FeesPaymentNotificationBackend extends AsyncTask<String,FeePayment,Void> {
    String json_string="http://192.168.1.102/smartvan/feesNotifyList.php";
    Context context;
    Activity activity;
    ...
    ArrayList<FeePayment> arrayList=new ArrayList<>();
    ProgressDialog progressDialog;
    //private RecycleAdapter.RecyclerViewClickListener listener;
    FeesPaymentNotificationBackend(Context ctx){
        context=ctx;
    ...
    protected Void doInBackground(String... params) {
        try {
            ...
            while (count<jsonArray.length()){
                ...
                count++;
                FeePayment fee=new FeePayment(jo.getInt("paymentID"),jo.getInt("childId"),jo.getString("fname"),jo.getString("lname"),jo.getString("amount"),jo.getString("payment_date"));
                publishProgress(fee);
                Thread.sleep(1000);
    ...
    protected void onPreExecute() {
        recyclerView=(RecyclerView)activity.findViewById(R.id.recyclerviewfeesnotify);
        layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        adapter=new RecyclerAdapterFeesNotify(arrayList,context);
...
//    }
    ...
    @Override
    protected void onProgressUpdate(FeePayment... values) {
